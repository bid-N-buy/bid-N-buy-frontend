...
const AdminResetPassword = () => {
  ...
  const sendCode = async () => {
    ...
    try {
      ...
      const { data } = await post("/admin/auth/password/request", {
  ...
  const verifyCode = async () => {
    ...
    try {
      ...
      const { data } = await post("/admin/auth/password/verify", body);
      ...
      setMsg(
        data?.message ?? "인증이 완료되었습니다. 비밀번호를 재설정해 주세요."
      );
      setStep("reset");
    } catch (e) {
      const err = e as AxiosError<{ message?: string; error?: string }>;
  ...
  const resetPassword = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const { data } = await post("/admin/auth/password/reset", payload);
  ...
  return (
    <div className="mx-auto mt-[100px] w-[80%] md:w-[420px]">
      {/* 헤더 */}
        ...
        <div className="space-y-5">
          <div>
            ...
            <input
              ...
              className="hover:border-purple mb-[10px] w-full rounded-md border px-3 py-2 outline-none"
              placeholder="이메일 입력"
              autoComplete="email"
            />
            ...
            <div className="flex gap-[10px]">
              <input
                ...
                className="hover:border-purple w-1/2 rounded-md border px-3 py-2 outline-none"
              ...
              <button
                ...
                className="border-purple text-purple hover:bg-purple/5 w-1/4 rounded-md border disabled:opacity-60"
              >
              ...
              <button
                ...
                className="bg-purple w-1/4 rounded-md font-medium text-white hover:opacity-90 disabled:opacity-60"
              >
                인증 하기
              </button>
            </div>
        ...
        <form onSubmit={resetPassword} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="hover:border-purple mb-2 w-full rounded-md border px-3 py-2 outline-none"
            ...
            <input
              ...
              className="hover:border-purple w-full rounded-md border px-3 py-2 outline-none"
